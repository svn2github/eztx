...
namespace _3d
{
    public partial class OutputFormForEast : Form
    {
        public OutputFormForEast()
        {
            InitializeComponent();
        }

        private OutputFormZhiXuan otForm = null;
        Form1 f1 = new Form1();
        ...
        private void zuZhuanZhi_Click(object sender, EventArgs e)
        {
            if (otForm == null || otForm.IsDisposed)//判断窗口是否打开
            {
                otForm = new OutputFormZhiXuan();
