...
namespace System.Windows.Forms
{
	...
	public abstract class TabStyleProvider : Component
	{
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields")]
        protected Font _TabFont = new Font("宋体",9F);

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields")]
        protected Font _TabFontSelect = new Font("宋体", 9F);

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields")]
        protected Color _TabBackColorSelect = Color.WhiteSmoke;

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields")]
        protected Color _FocusColor2 = SystemColors.Window;
		...
		protected virtual Brush GetTabBackgroundBrush(int index){
			...
			if (this._TabControl.SelectedIndex == index) {
                dark = this.TabBackColorSelect;//SystemColors.ControlLight;
                light = this.TabBackColorSelect;//默认为SystemColors.Window;更改为标签背景能够根据tabpage页背景进行变换
        ...
        [Description("是否显示关闭Tab按钮"), Category("Appearance")]
        ...
        [Description("选中Tab边框颜色"), Category("Appearance"), DefaultValue(typeof(Color), "")]
        ...
        [Description("边框颜色"), Category("Appearance"), DefaultValue(typeof(Color), "")]
        ...
        [Description("文字颜色"), Category("Appearance"), DefaultValue(typeof(Color), "")]
        ...
        [Description("选中标签文字颜色"), Category("Appearance"), DefaultValue(typeof(Color), "")]
        ...
        [Description("未启用标签文字颜色"), Category("Appearance"), DefaultValue(typeof(Color), "")]
        ...
        [Description("选中Tab焦点颜色"), Category("Appearance"), DefaultValue(typeof(Color), "Orange")]
        ...
        [Description("关闭按钮活动颜色"), Category("Appearance"), DefaultValue(typeof(Color), "Black")]
        ...
        [Description("关闭按钮颜色"), Category("Appearance"), DefaultValue(typeof(Color), "DarkGrey")]
        ...
        [Description("Tab中文本的字体"), Category("Appearance")]
        public Font TabFont
        {
            get { return _TabFont; }
            set
        ...
        [Description("Tab中选中页面的文本字体"), Category("Appearance")]
        public Font TabFontSelect
        {
            get { return _TabFontSelect; }
            set
            {
                _TabFontSelect = value;
                this._TabControl.Invalidate();
            }
        }

        [Description("Tab选中标签背景颜色"), Category("Appearance")]
        public Color TabBackColorSelect
        {
            get { return _TabBackColorSelect; }
            set
            {
                _TabBackColorSelect = value;
                this._TabControl.Invalidate();
            }
        }

        [Description("选中Tab焦点颜色2,与focus颜色1进行渐变"), Category("Appearance")]
        public Color FocusColor2
        {
            get { return this._FocusColor2; }
            set
            {
                this._FocusColor2 = value;
                this._TabControl.Invalidate();
            }
        }
		...
		public void PaintTab(int index, Graphics graphics){
			using (GraphicsPath tabpath = this.GetTabBorder(index)) {
				using (Brush fillBrush = this.GetTabBackgroundBrush(index)) {
                    ...
                    graphics.FillPath(fillBrush, tabpath);//fillBrush
			...
			if (this._FocusTrack && this._TabControl.Focused && index == this._TabControl.SelectedIndex) {
				...
				switch (this._TabControl.Alignment) {
					case TabAlignment.Top:
                        ...
                        //两个color代表渐变，从xx颜色到xx颜色
						focusBrush = new LinearGradientBrush(focusRect,this._FocusColor,this._FocusColor2, LinearGradientMode.Vertical);
						break;
					case TabAlignment.Bottom:
