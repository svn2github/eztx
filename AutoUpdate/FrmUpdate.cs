...
//				btnNext.Enabled = false;
		...
		private void DownUpdateFile()
		{
            ...
            //取主程序的名称，从xml配置文件中读取EntryPoint节点，然后循环出所有的进程并进行对比，如果相同，则结束进程
